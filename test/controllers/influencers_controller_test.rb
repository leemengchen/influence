...
class InfluencersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create influencer" do
    assert_difference('Influencer.count') do
      post influencers_url, params: { influencer: { email: @influencer.email, firstName: @influencer.firstName, gender: @influencer.gender, igUsername: @influencer.igUsername, lastName: @influencer.lastName } }
    end
  ...
  test "should update influencer" do
    patch influencer_url(@influencer), params: { influencer: { email: @influencer.email, firstName: @influencer.firstName, gender: @influencer.gender, igUsername: @influencer.igUsername, lastName: @influencer.lastName } }
